          ...
          Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  Image.asset(
                    'android/assets/images/venus.jpg', // Venus image
                    height: 250,
                    fit: BoxFit.cover,
                  ),
                  ...
                  const Text(
                    'الزهرة هو الكوكب الثاني من الشمس وهو الأقرب إلى الأرض من بين جميع كواكب النظام الشمسي. '
                    'تُعرف الزهرة بدرجات الحرارة العالية والغلاف الجوي السميك.',
                    style: TextStyle(
                      fontSize: 18,
                      color: Colors.white,
                    ),
                  ...
                  Table(
                    ...
                    children: [
                      _buildTableRow('المسافة من الشمس', '108.2 مليون كم'),
                      _buildTableRow('القطر', '12,104 كم'),
                      _buildTableRow('متوسط درجة الحرارة', '462°C'),
                      _buildTableRow(
                          'الغلاف الجوي', '96.5% من ثاني أكسيد الكربون'),
